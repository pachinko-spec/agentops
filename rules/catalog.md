...
| phase-owner-declaration | plan / task の Phase ごとに担当列と着手前 1 行宣言欄を置き、編集前に担当モデルと役割を明示する | global / project | 複数モデル委譲や 5 工程フローを使う運用では global 候補 | phase-ownership-lint | design-review | — |
