...
- [生成テンプレート](templates/README.md)
- [旧参照キット実体](archive/reference-kit-v1/README.md)
...
- [参照キットのカタログ化判断](decisions/2026-04-27-reference-kit-catalog-pivot.md)
- [参照キットカタログ化計画](.agentops/archive/2026-04-27-reference-kit-catalog-pivot/plan.md)
...
- 旧 rules / skills / workflows 実体: `archive/reference-kit-v1/`
- グローバル設定反映チェックリスト: `docs/16-global-settings-application-checklist.md`
